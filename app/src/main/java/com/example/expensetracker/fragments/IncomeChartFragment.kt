...
import com.example.expensetracker.databinding.FragmentIncomeChartBinding
...
class IncomeChartFragment : Fragment() {
    ...
    private fun setupPieChart() {
        binding.incomePieChart.apply {
            ...
            centerText = "Incomes by categories"
            rotationAngle = 0f
            ...
            try {
                ...
                if (response.isSuccessful) {
                    response.body()?.let { transactions ->
                        ...
                        val categoryIncomes = incomes.groupBy { it.category }
                        ...
                        for ((category, amount) in categoryIncomes) {
                        ...
                        data.setValueFormatter(PercentFormatter(binding.incomePieChart))
                        data.setValueTextSize(11f)
                        data.setValueTextColor(Color.BLACK)

                        binding.incomePieChart.data = data
    ...
    // Reload chart data whenever the fragment resumes (e.g., when user navigates to this tab)
